...
<h5 class="has-text-indigo margin--bottom--lg" id="playlist-safe"><b>Playlist: Stay Safe, Stay Informed</b></h5>
...
<img src="images/digital/teens/tt-gd-2b.png" alt="One-time online usage – no need to create account. Easy to freehand vector graphics and shapes. Downloadable in 3 file formats - .png, .jpg, .svg." style="width: 70%;">
...
<img src="images/digital/teens/tt-gd-3b.png" alt="Opening file formats that you may not have the software to open. Web-based application that you can use on your web browser. Accessible on mobile – work on the go!" style="width: 70%;">
...
<img src="images/digital/teens/tt-gd-4b.png" alt="Simple scroll webpages, adaptable for mobile dimensions. Easy to embed your own .gifs, images, and YouTube videos. Drag-and-drop builder is intuitive for new users." style="width: 70%;">
