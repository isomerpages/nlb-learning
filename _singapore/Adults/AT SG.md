...
<div class="row is-multiline">
  ...
  <div class="col is-one-third">
    ...
    <div class="clickbox is-mint-jade">
      <a href="#nasdisplay">
        <span>Display: Experiencing SG Through Our Senses</span>
      </a>
    </div>
  </div>
  </div>
...
<br>Visit the National Archives of Singapore for a new display spotlighting the history of selected spaces in the Bras Basah.Bugis precinct – some long gone, some less remembered, but all full of charm waiting to be rediscovered. Learn something new about Bras Basah.Bugis as you explore this visual showcase!</div>