...
<div class="horizontal-scroll margin--bottom--lg">
  <table class="generic-table">
    ...
    <tbody>
      <tr>
        <td style="width: 20%;">
					<a href="https://childrenandteens.nlb.gov.sg/diy-resources/preschool-resources/i-can-read#lp-talk" target="_blank"><b> Early Literacy Practice (Ages 0 to 3)</b></a></td>
